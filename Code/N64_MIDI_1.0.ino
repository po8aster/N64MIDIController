...
//D Pad
int synthDR = 38; //Snare on Drum Channel
int synthDL = 35; //Kick on Drum Channel
...
//State tracking for Mod/CC and Pitch Bend
int ccState = 0;
int ccStateLast = 0;
...
int pitchBendUSBval = pitchBend; //make a seperate value to modify for USB 
//Convert 8 bit pitchbend value to 7 bit
  ...
  int pitchBendTrad = pitchBend - 8192; //make a new value for Traditional MIDI
